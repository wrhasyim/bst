<div class="max-w-2xl mx-auto space-y-8 pb-10">
    ...
    <div class="bg-white rounded-[3rem] border border-slate-200 p-8 shadow-sm"
         x-data="{ 
             ...
             get isError() { return this.detail ? (this.jumlah > parseFloat(this.detail.stok_tersedia)) : false }
         }">
        ...
        <form action="<?= BASE_URL ?>/penjualan/store" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="kategori_id" x-model="katId" required 
                        @change="harga = detail ? parseFloat(detail.harga_pengepul) : 0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        <!-- 🛠️ FIX: name="total_pcs" -->
                        <input type="number" step="1" name="total_pcs" x-model.number="jumlah" required min="1"
                    ...
                    <p x-show="isError" class="text-[10px] text-red-600 font-bold mt-2 ml-1 italic">❌ Stok tidak cukup! Maksimal: <span x-text="detail.stok_tersedia"></span> Pcs.</p>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <!-- 🛠️ FIX: name="harga_per_pcs" -->
                        <input type="number" name="harga_per_pcs" x-model.number="harga" required 
