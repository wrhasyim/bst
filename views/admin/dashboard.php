<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-slate-900 p-5 rounded-2xl text-white shadow-xl">
            ...
            <p class="text-[8px] text-slate-400 mt-3 font-medium italic">*Uang tunai diterima dari pengepul</p>
        </div>
        ...
        <div class="bg-emerald-50 p-5 rounded-2xl border border-emerald-100 shadow-sm">
            ...
            <p class="text-[8px] text-emerald-600 mt-3 font-medium">*Laba nyata dari barang terjual</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?= BASE_URL ?>/user" class="text-[10px] font-bold text-emerald-600 hover:underline italic">Kelola Semua ➡️</a>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-colors">
                ...
                <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-slate-100 transition-colors">
                    ...
                    <span class="text-[10px] font-bold text-slate-400 uppercase">Guru & Staf</span>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="p-6 bg-emerald-600 rounded-3xl shadow-lg shadow-emerald-200 text-white group">
                <h4 class="font-bold text-sm mb-1 italic">Input Setoran?</h4>
                <p class="text-[10px] opacity-80 mb-4">Catat tabungan siswa per kelas dengan cepat.</p>
            ...
            <div class="p-6 bg-slate-800 rounded-3xl shadow-lg text-white group">
                <h4 class="font-bold text-sm mb-1 italic">Proses Penjualan?</h4>
                <p class="text-[10px] opacity-80 mb-4">Konversi stok gudang menjadi kas tunai pengepul.</p>
                <a href="<?= BASE_URL ?>/penjualan" class="flex items-center justify-center py-2 bg-slate-700 text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-transform group-hover:scale-105">
                    Jual Sekarang
                </a>
            </div>
        </div>
